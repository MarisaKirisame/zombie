...
#define IMPORT_ZOMBIE(cfg)\
    ...
    template<typename F>                                                                             \
    inline auto bindZombieUnTyped(F&& f, const std::vector<ZombieInternal::EZombie<cfg>>& x) {       \
    ...
    inline auto TailCall(F&& f, const Zombie<Arg>& ...x) {                                           \
      return ZombieInternal::TailCall<cfg, F, Arg...>(std::forward<F>(f), x...);                     \
    }                                                                                                \
    ;
